...
<template>
  <div class="mx-[120px]">
    <div class="bg-secondary rounded-t-[20px] text-white flex flex-col items-center pt-[67px]">
      <h2 class="section-title text-center w-[677px] mb-[22px]">Entre ton e-mail pour recevoir le programme de
        lՎcole</h2>
